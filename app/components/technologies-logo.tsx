...
const TechnologiesLogo = () => {
 return (
  <div className="w-full aspect-square flex relative">
   ...
   <div
    className="absolute left-[15%] top-[20%] w-[45%] aspect-square rounded-full bg-[#5136ed] shadow-[0_0_50px_0px_#5136ed70] hover:scale-105 hover:shadow-[0_0_50px_0px_#5136ed] transition duration-500"
